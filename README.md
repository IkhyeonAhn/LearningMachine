...
<hr>
 ...
 - ## **프로젝트 후 소감**
	 + 느낀 점
		  - 나중에 코드를 변경하거나, 기능을 구현할 때 효율적으로 코드를 작성할 수 있을지 많은 생각을 하고, 실습할 수 있는 계기가 되었습니다.
		  - 협업을 하며 기능에 따른 데이터베이스 설계 및 기능 설계를 어떻게 해야 좋을지 고민하고, 나름 좋은 결과를 낸 것 같아 보람을 느꼈습니다.
		  - 팀원들과 회의와 대화를 통해 고민을 하고, 목표에 맞는 기능을 함께 구현한 것에 보람을 느꼈습니다.
		  - 기능뿐 아니라 효율적인 코딩을 위해 체계적인 설계가 꼭!!필요함을 느꼈습니다.
		  - Spring MVC라는 프레임워크의 개념을 공부하며 이해하고, 적용하며 배우는 계기가 되었습니다.

	 + 아쉬웠던 점
		 - 프로젝트 주제를 정하고 설계를 할 때 좀 더 구체적으로 기획 못해서 아쉬웠습니다.
		 - 분업할 때 GitHub 충돌을 피하기 위해 3개의 페이지를 나눠 작업했는데,  기초 코드를 다져놓지 않은 상태에서 코딩을 하여 팀원들의 코드(Mapper의 SQL문과 DAO)가 겹치는 것이 아쉬웠습니다.
		 - 나름 MVC를 패턴을 적용시킨 것 같은데, 엉성한 부분이 있어 조금 아쉽습니다.
		 - 프로젝트 기간이 짧아 효율적이라고 생각한 코딩을 적용 못한 것이 아쉬웠습니다.
		 - Spring을 공부하고 개발하며 Security, Cloud, AOP 등 관심을 가졌던 것들을 공부, 적용을 하지 못한 것이 아쉽습니다.
